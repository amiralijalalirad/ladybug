# NABEGHEHA.COM
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - -#
# Github       : https://github.com/NABEGHEHACOM/CarRace
# Youtube      : https://youtube.com/playlist?list=PLdIE-46QLU9JFRYqp9_vCeDH8Hx1GjMG5
...
def game_intro():
    ...
    while intro:
        ...
        gameDisplay.blit(TextSurf, TextRect)
        button("Enter", 150, 450, 100, 50, green, bright_green, game_loop)
